...
const n = 2;
const recipes = ["SPAGHETTI 3", "FRIEDRICE 2", "PIZZA 8"];
const orders = ["PIZZA 1", "FRIEDRICE 2", "SPAGHETTI 4", "SPAGHETTI 6", "PIZZA 7", "SPAGHETTI 8"];
console.log((solution(n, recipes, orders)));
